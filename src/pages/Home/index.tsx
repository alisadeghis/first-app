        ...
        <>
          <div className="tw-px-5">
            <div className="tw-flex tw-flex-wrap -tw-m-5">
              <div className="md:tw-w-6/12 tw-w-full tw-p-5">
                    ...
                    <div className="details tw-w-6/12">
                      ...
                      <div className="tw-mt-5">
                        ...
                        <div className="tw-flex tw-items-center tw-gap-x-2 tw-text-xs">
                          <span>
                            {i18nT("HIGH")}: {dailyWeather?.current.heatindex_c}
                          </span>
                          <span>
                            {i18nT("LOW")}: {dailyWeather?.current.dewpoint_c}
                          </span>
                        </div>
                      </div>
                    </div>
          ...
          <div className="tw-p-3">
            <div className="tw-mt-10 tw-flex tw-overflow-auto -tw-m-3">
              {dailyWeather?.forecast.forecastday.map((weather) => (
                <div key={weather.date} className="tw-p-3 tw-h-full tw-w-[175px] tw-shrink-0">
                  <WeatherCard {...weather} />
                </div>
              ))}
            </div>
